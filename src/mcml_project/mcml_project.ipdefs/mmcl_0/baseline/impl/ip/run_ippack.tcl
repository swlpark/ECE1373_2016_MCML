...
set IPName      "mcml"
set Version     "1.0"
set DisplayName "Mcml"
set Revision    "1604262058"
...
set Interfaces {
    s_axi_CTRL_REG {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_CTRL_REG"
        param_prefix "C_S_AXI_CTRL_REG"
        addr_bits "8"
        port_width "AWADDR 8 WDATA 32 WSTRB 4 ARADDR 8 RDATA 32"
        registers {{ 0x00 CTRL       RW   0x0 "Control signals"  {  { 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." }  { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." }  { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." }  { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." }  { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." }  { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." }  { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }  } }  { 0x04 GIER       RW   0x0 "Global Interrupt Enable Register"   {  { 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" }  { 1 30 RESERVED R 0 "Reserved.  0s on read." }  } }  { 0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register"   {  { 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." }  { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." }  { 2 30 RESERVED R 0 "Reserved.  0s on read." }  } }  { 0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register"   {  { 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" }  { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" }  { 2 30 RESERVED R 0 "Reserved.  0s on read." }  } } {0x10 kernel_info_p_num_photons_i W 0x0 "Data signal of kernel_info_p_num_photons_i" {{0 32 kernel_info_p_num_photons_i W 0 "Bit 31 to 0 Data signal of kernel_info_p_num_photons_i"}}} {0x18 kernel_info_p_num_photons_o R 0x0 "Data signal of kernel_info_p_num_photons_o" {{0 32 kernel_info_p_num_photons_o R 0 "Bit 31 to 0 Data signal of kernel_info_p_num_photons_o"}}} {0x1c kernel_info_p_num_photons_o_ctrl R 0x0 "Control signal of kernel_info_p_num_photons_o" {{0 1 kernel_info_p_num_photons_o_ap_vld R 0 "Control signal kernel_info_p_num_photons_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 kernel_info_p_dz_i W 0x0 "Data signal of kernel_info_p_dz_i" {{0 32 kernel_info_p_dz_i W 0 "Bit 31 to 0 Data signal of kernel_info_p_dz_i"}}} {0x28 kernel_info_p_dz_o R 0x0 "Data signal of kernel_info_p_dz_o" {{0 32 kernel_info_p_dz_o R 0 "Bit 31 to 0 Data signal of kernel_info_p_dz_o"}}} {0x2c kernel_info_p_dz_o_ctrl R 0x0 "Control signal of kernel_info_p_dz_o" {{0 1 kernel_info_p_dz_o_ap_vld R 0 "Control signal kernel_info_p_dz_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 kernel_info_p_dr_i W 0x0 "Data signal of kernel_info_p_dr_i" {{0 32 kernel_info_p_dr_i W 0 "Bit 31 to 0 Data signal of kernel_info_p_dr_i"}}} {0x38 kernel_info_p_dr_o R 0x0 "Data signal of kernel_info_p_dr_o" {{0 32 kernel_info_p_dr_o R 0 "Bit 31 to 0 Data signal of kernel_info_p_dr_o"}}} {0x3c kernel_info_p_dr_o_ctrl R 0x0 "Control signal of kernel_info_p_dr_o" {{0 1 kernel_info_p_dr_o_ap_vld R 0 "Control signal kernel_info_p_dr_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x40 kernel_info_p_da_i W 0x0 "Data signal of kernel_info_p_da_i" {{0 32 kernel_info_p_da_i W 0 "Bit 31 to 0 Data signal of kernel_info_p_da_i"}}} {0x48 kernel_info_p_da_o R 0x0 "Data signal of kernel_info_p_da_o" {{0 32 kernel_info_p_da_o R 0 "Bit 31 to 0 Data signal of kernel_info_p_da_o"}}} {0x4c kernel_info_p_da_o_ctrl R 0x0 "Control signal of kernel_info_p_da_o" {{0 1 kernel_info_p_da_o_ap_vld R 0 "Control signal kernel_info_p_da_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x50 kernel_info_p_nz_i W 0x0 "Data signal of kernel_info_p_nz_i" {{0 16 kernel_info_p_nz_i W 0 "Bit 15 to 0 Data signal of kernel_info_p_nz_i"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x58 kernel_info_p_nz_o R 0x0 "Data signal of kernel_info_p_nz_o" {{0 16 kernel_info_p_nz_o R 0 "Bit 15 to 0 Data signal of kernel_info_p_nz_o"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x5c kernel_info_p_nz_o_ctrl R 0x0 "Control signal of kernel_info_p_nz_o" {{0 1 kernel_info_p_nz_o_ap_vld R 0 "Control signal kernel_info_p_nz_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x60 kernel_info_p_nr_i W 0x0 "Data signal of kernel_info_p_nr_i" {{0 16 kernel_info_p_nr_i W 0 "Bit 15 to 0 Data signal of kernel_info_p_nr_i"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x68 kernel_info_p_nr_o R 0x0 "Data signal of kernel_info_p_nr_o" {{0 16 kernel_info_p_nr_o R 0 "Bit 15 to 0 Data signal of kernel_info_p_nr_o"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x6c kernel_info_p_nr_o_ctrl R 0x0 "Control signal of kernel_info_p_nr_o" {{0 1 kernel_info_p_nr_o_ap_vld R 0 "Control signal kernel_info_p_nr_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x70 kernel_info_p_na_i W 0x0 "Data signal of kernel_info_p_na_i" {{0 16 kernel_info_p_na_i W 0 "Bit 15 to 0 Data signal of kernel_info_p_na_i"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x78 kernel_info_p_na_o R 0x0 "Data signal of kernel_info_p_na_o" {{0 16 kernel_info_p_na_o R 0 "Bit 15 to 0 Data signal of kernel_info_p_na_o"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x7c kernel_info_p_na_o_ctrl R 0x0 "Control signal of kernel_info_p_na_o" {{0 1 kernel_info_p_na_o_ap_vld R 0 "Control signal kernel_info_p_na_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x80 kernel_info_p_num_layers_i W 0x0 "Data signal of kernel_info_p_num_layers_i" {{0 16 kernel_info_p_num_layers_i W 0 "Bit 15 to 0 Data signal of kernel_info_p_num_layers_i"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x88 kernel_info_p_num_layers_o R 0x0 "Data signal of kernel_info_p_num_layers_o" {{0 16 kernel_info_p_num_layers_o R 0 "Bit 15 to 0 Data signal of kernel_info_p_num_layers_o"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x8c kernel_info_p_num_layers_o_ctrl R 0x0 "Control signal of kernel_info_p_num_layers_o" {{0 1 kernel_info_p_num_layers_o_ap_vld R 0 "Control signal kernel_info_p_num_layers_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_CTRL_REG m_axi_kernel_info_p_Rd_ra m_axi_kernel_info_p_A_rz m_axi_kernel_info_p_Tt_ra"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    kernel_info_p_layerspecs_z0 {
        type "native_bram"
        mode "master"
        port_prefix "kernel_info_p_layerspecs_z0"
        mem_width "32"
        mem_depth "10"
        mem_ports "a"
        addr_width "32"
    ...
    kernel_info_p_layerspecs_z1 {
        type "native_bram"
        mode "master"
        port_prefix "kernel_info_p_layerspecs_z1"
        mem_width "32"
        mem_depth "10"
        mem_ports "a"
        addr_width "32"
    ...
    kernel_info_p_layerspecs_n {
        type "native_bram"
        mode "master"
        port_prefix "kernel_info_p_layerspecs_n"
        mem_width "32"
        mem_depth "10"
        mem_ports "a"
        addr_width "32"
    ...
    kernel_info_p_layerspecs_mua {
        type "native_bram"
        mode "master"
        port_prefix "kernel_info_p_layerspecs_mua"
        mem_width "32"
        mem_depth "10"
        mem_ports "a"
        addr_width "32"
    ...
    kernel_info_p_layerspecs_mus {
        type "native_bram"
        mode "master"
        port_prefix "kernel_info_p_layerspecs_mus"
        mem_width "32"
        mem_depth "10"
        mem_ports "a"
        addr_width "32"
    ...
    kernel_info_p_layerspecs_g {
        type "native_bram"
        mode "master"
        port_prefix "kernel_info_p_layerspecs_g"
        mem_width "32"
        mem_depth "10"
        mem_ports "a"
        addr_width "32"
    ...
    kernel_info_p_layerspecs_cos_crit0 {
        type "native_bram"
        mode "master"
        port_prefix "kernel_info_p_layerspecs_cos_crit0"
        mem_width "32"
        mem_depth "10"
        mem_ports "a"
        addr_width "32"
    ...
    kernel_info_p_layerspecs_cos_crit1 {
        type "native_bram"
        mode "master"
        port_prefix "kernel_info_p_layerspecs_cos_crit1"
        mem_width "32"
        mem_depth "10"
        mem_ports "a"
        addr_width "32"
    ...
    m_axi_kernel_info_p_Rd_ra {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_kernel_info_p_Rd_ra"
        data_width "32"
        param_prefix "C_M_AXI_KERNEL_INFO_P_RD_RA"
    ...
    m_axi_kernel_info_p_A_rz {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_kernel_info_p_A_rz"
        data_width "32"
        param_prefix "C_M_AXI_KERNEL_INFO_P_A_RZ"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_kernel_info_p_Tt_ra {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_kernel_info_p_Tt_ra"
        data_width "32"
        param_prefix "C_M_AXI_KERNEL_INFO_P_TT_RA"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
...
## System Info
set user_parameters_list {clk_period 3.000000 machine 64 combinational 0 latency undef II x}
...
set enable_xo_gen 0
set kernel_files {C:/Users/lawpark/Documents/hls_prj/mmcl/mcml.cpp}
if {$enable_xo_gen} {
