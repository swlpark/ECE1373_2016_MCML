...
int main (void)
{
	...
	kernel_info.layerspecs[1].z1 = 0.2;
	kernel_info.layerspecs[1].n = 1.37;
	kernel_info.layerspecs[1].mua = 1;
	kernel_info.layerspecs[1].mus = 1;
	kernel_info.layerspecs[1].g = 0.5;

	kernel_info.layerspecs[2].z0 = 0.2;
	kernel_info.layerspecs[2].z1 = 0.4;
	kernel_info.layerspecs[2].n = 1.37;
	kernel_info.layerspecs[2].mua = 1;
	kernel_info.layerspecs[2].mus = 10;
	kernel_info.layerspecs[2].g = 0.0;

	kernel_info.layerspecs[3].z0 = 0;
	kernel_info.layerspecs[3].z1 = 0;
	kernel_info.layerspecs[3].n = 1;
	kernel_info.layerspecs[3].mua = 0;
	kernel_info.layerspecs[3].mus = 0;
	kernel_info.layerspecs[3].g = 0;
